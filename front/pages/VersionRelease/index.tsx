      ...
      <div className=' flex relative mt-20 md:mt-24 pb-36 items-center max-w-2xl lg:max-w-4xl px-6 lg:px-8 mx-auto'>
        <div className='lg:pr-8 lg:pt-4'>
          ...
          <p className='mt-6 text-lg leading-8 '>
            BlooWays 개발자입니다. 본 웹서비스의 베타 단계 개발을 완료했습니다. 이 곳에서는 BlooWays 서비스
            버전에 관한 변경 내역을 알려드립니다.
          </p>
          <div className='flex lg:flex-row flex-col mt-10 w-full gap-10 text-base leading-7  lg:max-w-none'>
            <div className='lg:w-1/2 w-full relative pl-9'>
              ...
              <div className='mb-2'>
                ...
                베타 단계를 배포 중이며 새롭게 추가되는 내용이 있다면 해당 항목에서 자세히 알려드립니다. 또한
                정식 릴리즈 모드인 1.0에서 많은 것들이 추가되고 업데이트 될 것입니다.
              </div>
              <div className='mb-2'>
                <div className='w-[4px] h-[4px] mr-0.5 bg-slate-700 rounded-full inline-block relative bottom-1' />{' '}
